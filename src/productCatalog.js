...
document.getElementById("inputSearchType").addEventListener('click',function(){
    processSearchType(document.getElementById('inputType').value);
});

document.getElementById("inputSearchPrice").addEventListener('click',function(){
